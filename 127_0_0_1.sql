...
--
-- Host: 127.0.0.1
-- Generation Time: 2017 年 1 朁E26 日 10:46
...
-- Database: `ci_test`
--
CREATE DATABASE IF NOT EXISTS `ci_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `ci_test`;
...
(1, 'テスト３３３３', 'テスト３３３３', 'dsfsfdsf'),
(2, 'テスト４４４４', 'テスト４４４４', 'fdsfdsfdsf\r\n'),
(3, 'テスト55555', 'テスト55555', 'fdfdsf');
...
INSERT INTO `test` (`content`, `text`) VALUES
('テスト', 'テストｆｄｆｄｓｆｄ');
...
INSERT INTO `users` (`id`, `birthday`, `name`, `license_no`, `mail_address`) VALUES
(1, '1980-04-25', 'test1', 'aaabbbccc001', 'test@gmail.com'),
(2, '1981-01-01', 'test2', 'aaabbbccc002', 'test2@gmail.com');
...
('root', '[{"db":"ci_test","table":"news"},{"db":"ci_test","table":"test"},{"db":"ci_test","table":"news_xx"},{"db":"ci_test","table":"users"}]');
...
('root', '2017-01-23 05:07:52', '{"lang":"ja","collation_connection":"utf8mb4_unicode_ci"}');
